# Exploratory Data Analysis {#sec-act1}
...
You can download the dataset at [this linttps://doi.org/10.24432/C5HS5C) @ai4i2020.
...
| RNF                 | Target   | Integer     |       | Random failures                                                                                                        | x      |
...
::: {.callout-note}
This is a warmup task with a polished, synthetic dataset and luckily we are provided with a description of the nature of the different errors.
:::



{{< embed /act1/1_0_ai4i.ipynb echo=true >}}
