...
![Airline passenger numbers](../data/assets/act2/airpassengers.png)
...
![Atmospheric CO2 concentrations](../data/assets/act2/mauna_loa_co2.png)
...
![Simulated Random Walk](../data/assets/act2/random_walk.png)

### S&P 500 index
This time series shows the daily closing prices of the S&P 500 in 2020.
Source: https://de.finance.yahoo.com/quote/%5EGSPC/ downloaded via the `yfinance` package.

![S&P 500 index](../data/assets/act2/sandp_500_close_2020.png)
...
![Electrocardiogram (ECG) Signal](../data/assets/act2/electrocardiogram.png)
