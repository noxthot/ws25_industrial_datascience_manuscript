# Self study - Session 1 {#sec-2-selfstudy1}
...
In this session, we will revisit @{sec-act2-imputation} and @{sec-act2-decomposition}.

In @{sec-act2-imputation}, we have explored different methods to handle missing data in time series and have seen that the choice of imputation method can significantly affect the results.
...
First, download the data set from [here](../data/assets/act2/selfstudysessions/sss1_production_data.csv).
...
- Experiment with different imputation methods discussed in @{sec-act2-imputation}.
...
We have had a look at STL in @{sec-act2-decomposition}, where we decomposed a time series into its components.
