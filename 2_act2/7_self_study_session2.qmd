...
In this session, we will revisit the chapters @{sec-act2-clustering}, @{sec-act2-classification}, and @{sec-act2-regression}.
...
::::
- Load the [`GesturePebbleZ1`](https://timeseriesclassification.com/description.php?Dataset=GesturePebbleZ1) data set.
...
In @{sec-act2-classification} and @{sec-act2-regression}, our input was univariate, meaning each sample consisted of exactly one time series.
...
::::
- Load the [`UWaveGestureLibrary`](https://timeseriesclassification.com/description.php?Dataset=GesturePebbleZ1) data set.
...
::: {.callout-note}
You can use `aeon`'s `load_regression` function to load the data sets mentioned below, e.g.
```python
