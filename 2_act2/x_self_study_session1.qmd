...
In this session, we will revisit @sec-act2-eda and continue where we left off, trying to improve the process.

The findings in @sec-act2-eda-summary were not sufficient to explain all defects, but we found a correlation between elevated pressure during the epoxy application step and excessive epoxy application (`NOK_1`).
