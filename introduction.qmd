...
This includes optimzing operations, predictive maintenance, quality control, supply chain management and automation by leveraging large volumes of sensor and process data.
...
@sec:act2 will spotlight a raw dataset which is the more typical case when facing data science challenges in industry.

Finally, we will use everything we have learned so far to control a simulated machine in @sec:act3.
