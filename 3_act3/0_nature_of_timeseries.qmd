...
Time series data is characterized by its temporal ordering, meaning that the order of the data points matters and can reveal patterns, trends, and seasonal variations over time.
...
![Airline passenger numbers](./data/_assets_act3/airline_passengers.png)
...
![Atmospheric CO2 concentrations](./data/_assets_act3/co2_concentrations.png)
...
![Simulated Random Walk](./data/_assets_act3/random_walk.png)

### S&P 500 index
This time series shows the daily closing prices of the S&P 500 in 2020.
![S&P 500 index](./data/_assets_act3/sandp_500_close_2020.png)
...
![Electrocardiogram (ECG) Signal](./data/_assets_act3/electrocardiogram.png)
