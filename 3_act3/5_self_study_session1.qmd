...
::::
The accompanying `readme.md` file shipped with the [`industrial_datascience_sim_machine_knifes` repository](https://github.com/noxthot/industrial_datascience_sim_machine_knifes/tree/v1.0.1) contains information on how to run the machine again with different parameters.
